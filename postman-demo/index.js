...
app.post('/createPO', (req, res) => {
    createPO.execute(req.body.buyerCRN, req.body.buyerName, req.body.sellerCRN, req.body.sellerName, req.body.drugName, req.body.serialNo, req.body.quantity).then (() => {
...
app.post('/createShipment', (req, res) => {
    createShipment.execute(req.body.buyerCRN, req.body.buyerName, req.body.drugName, req.body.listOfAssets, req.body.transporterCRN, req.body.transporterName, req.body.serialNo).then (() => {
...
app.post('/updateShipment', (req, res) => {
    updateShipment.execute(req.body.buyerCRN, req.body.buyerName, req.body.drugName, req.body.serialNo, req.body.transporterCRN).then (() => {
...
app.post('/retailDrug', (req, res) => {
    retailDrug.execute(req.body.drugName, req.body.serialNo, req.body.retailerCRN, req.body.retailerName, req.body.customerAadhar).then (() => {
